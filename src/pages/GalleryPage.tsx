...
const GalleryPage: React.FC = () => {
  const { account, isConnected, setNftBalance, addEvent, setLoading, setError, loading, error } = useAppState(); // Changed addEventLog to addEvent, isLoading to loading
  const walletClient = undefined; // wallet client not available in lightweight shim
  ...
  }, [account, isConnected, chain, setNftBalance, setError]);
  ...
  return (
    <div className="container mx-auto p-4 md:p-8">
      ...
      {loadingNfts && <p className="text-blue-400 text-center text-lg mb-4">Loading your NFTs...</p>}
      ...
      {isConnected && userNfts.length === 0 && !loadingNfts && (
